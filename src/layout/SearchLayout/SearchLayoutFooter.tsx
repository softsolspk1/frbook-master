...
const SearchLayoutFooter: React.FC<SearchLayoutFooterInterFace> = ({
  diffrentImage,
  animation,
}) => {
  return (
    <footer
      className={`${
        diffrentImage
          ? "footer-pt-space pb-0 footer-theme overflow-hidden"
          : "footer-t-space footer-bg"
      }`}
    >
      <Container>
          ...
          <Col lg="4" md="6">
            ...
            <div className="footer-content">
              <div className="footer-logo">
                <Image
                  src={`${ImagePath}/icon/${
                    diffrentImage ? "logo.png" : "logo-color.png"
                  }`}
                  alt=""
                  height={64}
                  width={80}
              ...
              <p>
                ...
                Utenim ad minim veniam, et dolore magna aliqua. Ut enim ad
                minimveniam, enim ad minim veniam
              </p>
        ...
        <Row>
          <Col xs="12">
            <div className="sub-footer">
              <p>
                Respire 2 © 2024. All rights reserved | Developed By Softsols
                Pakistan
              </p>
            </div>
          </Col>
