...
const CommonLayout: React.FC<CommonLayoutProps> = ({user,differentLogo,loaderName="defaultLoader",showFullSideBar,children,mainClass,headerClassName,sideBarClassName,HideConversationPanel,ConversationPanelClassName}) => {const [loaderShowKey, setLoaderShowKey] = useState("defaultLoader")
  return (
    <>
      {skeltonLoaderList[loaderName]}
      <CommonLayoutHeader user={user} headerClassName={headerClassName ? headerClassName : ""} differentLogo={differentLogo}/>
