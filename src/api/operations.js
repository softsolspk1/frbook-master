...
export const getLMSStats = async () => {
  const res = await fetch(process.env.API_BASE + "/lms/stats", {
    method: "GET",
    headers: {
      jwt: cookies().get("jwt")?.value,
    },
...
export const getModulesForCourse = async (courseId) => {
  const res = await fetch(process.env.API_BASE + `/courses/${courseId}/modules`, {
    method: "GET",
    headers: {
      jwt: cookies().get("jwt")?.value,
    },
...
export const getModule = async (id) => {
  const res = await fetch(process.env.API_BASE + `/modules/${id}`, {
    method: "GET",
    headers: {
      jwt: cookies().get("jwt")?.value,
    },
...
export const createModule = async (moduleData) => {
  const res = await fetch(process.env.API_BASE + "/modules", {
    method: "POST",
...
export const getLessonsForModule = async (moduleId) => {
  const res = await fetch(process.env.API_BASE + `/modules/${moduleId}/lessons`, {
    method: "GET",
    headers: {
      jwt: cookies().get("jwt")?.value,
    },
