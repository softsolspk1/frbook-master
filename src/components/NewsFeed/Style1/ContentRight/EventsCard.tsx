  ...
  return (
    <div className="event-box section-t-space ratio2_3">
      <div className="image-section bg-size blur-up lazyloaded">
        <CustomImage
          src={`${ImagePath}/${
            diffrentPath ? diffrentPath : "event"
          }/${eventImage}.jpg`}
              ...
              >
                <DropdownToggle color="transparent">
                  <a>
                    <DynamicFeatherIcon
                      iconName="Sun"
                      className="icon-dark stroke-width-3 icon iw-11 ih-11"
                    />
                  </a>
                </DropdownToggle>
                <DropdownMenu>
      ...
      <div className="event-content">
        ...
        <div className="bottom-part">
          <a className="event-btn">{GoingNotGoing}</a>
        </div>
        <a className="share-btn">
          <DynamicFeatherIcon
            iconName="CornerUpRight"
            className="icon-dark stroke-width-3 iw-14 ih-14"
          />
        </a>
      </div>
